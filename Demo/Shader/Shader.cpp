...
Shader::Shader(const char* fragmentCode, const char* vertexCode, const char* geometryCode)
{
...
void Shader::SetUInt(const char* name, uint32_t value) const
{
	SetUniformValue(glGetUniformLocation(m_Id, name), value);
}
...
void Shader::SetIVec2(const char* name, const glm::ivec2& value) const
{
	SetUniformValue(glGetUniformLocation(m_Id, name), value);
}

void Shader::SetIVec3(const char* name, const glm::ivec3& value) const
{
	SetUniformValue(glGetUniformLocation(m_Id, name), value);
}

void Shader::SetIVec4(const char* name, const glm::ivec4& value) const
{
	SetUniformValue(glGetUniformLocation(m_Id, name), value);
}

void Shader::SetUVec2(const char* name, const glm::uvec2& value) const
{
	SetUniformValue(glGetUniformLocation(m_Id, name), value);
}

void Shader::SetUVec3(const char* name, const glm::uvec3& value) const
{
	SetUniformValue(glGetUniformLocation(m_Id, name), value);
}

void Shader::SetUVec4(const char* name, const glm::uvec4& value) const
{
	SetUniformValue(glGetUniformLocation(m_Id, name), value);
}
...
void Shader::SetMat2x3(const char* name, const glm::mat2x3& value) const
{
	SetUniformValue(glGetUniformLocation(m_Id, name), value);
}

void Shader::SetMat2x4(const char* name, const glm::mat2x4& value) const
{
	SetUniformValue(glGetUniformLocation(m_Id, name), value);
}

void Shader::SetMat3x2(const char* name, const glm::mat3x2& value) const
{
	SetUniformValue(glGetUniformLocation(m_Id, name), value);
}

void Shader::SetMat3x4(const char* name, const glm::mat3x4& value) const
{
	SetUniformValue(glGetUniformLocation(m_Id, name), value);
}

void Shader::SetMat4x2(const char* name, const glm::mat4x2& value) const
{
	SetUniformValue(glGetUniformLocation(m_Id, name), value);
}

void Shader::SetMat4x3(const char* name, const glm::mat4x3& value) const
{
	SetUniformValue(glGetUniformLocation(m_Id, name), value);
}
